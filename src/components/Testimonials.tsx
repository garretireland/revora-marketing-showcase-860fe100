...
const testimonials = [
  {
    ...
    role: "Owner",
    result: "$23K in new revenue",
    timeframe: "First 90 days",
    leads: "38 qualified leads",
    quote: "Before Revora, we were spending thousands on ads with barely any results. Within 90 days, they delivered 38 qualified leads and we closed $23,000 in new business. The automated follow-up system alone was worth it.",
    rating: 5,
  },
  {
    name: "Marcus Johnson",
  ...
  },
  {
    ...
    role: "Owner",
    result: "$16K in new contracts",
    timeframe: "First 90 days",
    leads: "44 qualified leads",
